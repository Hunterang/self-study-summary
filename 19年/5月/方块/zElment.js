class zElement extends TeriseElment {
  constructor(x,y,nowStatus,color) {
    super(x,y,nowStatus,zElement)
    this.color = color
    this.status = [//四种状态表示每个小单元格的位置
          [{offsetX:0,offsetY:0},{offsetX:1,offsetY:0},{offsetX:1,offsetY:1},{offsetX:2,offsetY:1}],
          [{offsetX:1,offsetY:0},{offsetX:0,offsetY:1},{offsetX:1,offsetY:1},{offsetX:0,offsetY:2}],
          [{offsetX:0,offsetY:0},{offsetX:1,offsetY:0},{offsetX:1,offsetY:1},{offsetX:2,offsetY:1}],
          [{offsetX:1,offsetY:0},{offsetX:0,offsetY:1},{offsetX:1,offsetY:1},{offsetX:0,offsetY:2}],
        ]
